...
from MambaCD.changedetection.datasets.make_data_loader_pure import make_data_loader,DamageDataset_train
...
def main():
    ...
    parser.add_argument('--resume', type=str,
        ...
        default=None
        # default=r'./MambaCD/changedetection/saved_models/test/199.pth'
        )
