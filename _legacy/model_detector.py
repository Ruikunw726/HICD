...
def setup_parsers():
    ...
    parser_train.add_argument('--cfg', type=str, default='./HICD/changedetection/configs/vssm1/vssm_small_224.yaml')
    ...
    for p in [parser_infer]:
        ...
        # 内部参数
        p.add_argument('--cfg', type=str, default='./HICD/changedetection/configs/vssm1/vssm_small_224.yaml')
        ...
        p.add_argument('--resume', type=str, default='./HICD/changedetection/saved_models/test/data_test_model.pth')
    ...
    # 超参数 (来自原 parse_train 和 config.json)
    parser_eval.add_argument('--cfg', type=str, default='./HICD/changedetection/configs/vssm1/vssm_small_224.yaml')
...
def parse_train(args):
    ...
    # if not args.resume:
        # args.resume = './HICD/changedetection/saved_models/test/data_test_model.pth'
