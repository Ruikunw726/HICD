...
from HICD.changedetection.models.SemanticDecoder import SemanticDecoder
...
class STMambaBDA(nn.Module):
    ...
    def forward(self, pre_data, post_data):
        ...
        # output_building = self.decoder_building(post_features)
        # output_building1 = self.decoder_building(pre_features)
        # output_building2 = self.decoder_building(post_features)
        # output_building = output_building1 + output_building2
        # output_building = self.decoder_damage(pre_features, post_features)
