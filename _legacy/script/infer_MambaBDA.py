...
from HICD.changedetection.datasets.make_data_loader import DamageAssessmentDatset, make_data_loader
...
def main():
    ...
    parser.add_argument('--cfg', type=str, default=r'E:/HICD/changedetection/configs/vssm1/vssm_small_224.yaml')
    parser.add_argument(
        "--opts",
