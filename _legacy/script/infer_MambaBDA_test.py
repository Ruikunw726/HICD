...
from HICD.changedetection.datasets.make_data_loader import make_data_loader,DamageDataset
...
def main():
    ...
    parser.add_argument('--cfg', type=str, default='./HICD/changedetection/configs/vssm1/vssm_small_224.yaml')
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--test_dataset_path', type=str, default='./HICD/test')
    parser.add_argument('--test_data_list_path', type=str, default='./HICD/test/test.txt')
    ...
    parser.add_argument('--resume', type=str,
        ...
        default='./HICD/changedetection/saved_models/test/data_test_model.pth'
    )
